...
7. On the **Create a Chatbot** page enter the following details :
   ...
   > **Note**: You can retrieve the DeploymentID from the environment details tab.
...
bot which we created on the **Power virtual agents** page. Then, click **Create**.
   ...
   >**Note**: In the occasion where the following screen does not appear in Composer on launch, you will need to close the xapplication and launch it again from Power Virtual Agents.
