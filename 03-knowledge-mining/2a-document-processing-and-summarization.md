   ...
   def authenticate_client():
    ...
    def sample_extractive_summarization(client):
        ...
        document = [
           ...
           "It draws its strength from transfer learning across monolingual and harnesses the shared nature of languages to produce improved quality and efficiency models. "
         ]
